---
titulo: "Quando Cuidar em Casa Deixa de Ser o Melhor Caminho: a verdade sobre as instituições de longa permanência"
categoria: "Família"
...
![Ilustração de uma sala de estar aconchegante vista através de uma porta entreaberta, com poltrona, xícara de café e luz suave entrando pela janela](/img/01-capa-casa-memorias.png)
*Uma casa cheia de memórias — e, às vezes, de riscos que não vemos.*
...
![Ilustração de uma casa vista por uma porta, com uma pequena balança em primeiro plano equilibrando ícones de banho, roupa e talheres de um lado e uma casa do outro](/img/02-balanca-tres-atividades.png)
*Quando três atividades básicas pesam mais do que a casa consegue sustentar.*
...
![Ilustração de uma pasta de documentos com o título "Dossiê de Custódia", um clipe de papel e uma caneta ao lado](/img/03-dossie-custodia.png)
*Cuidar também virou, sem que ninguém avisasse, uma responsabilidade jurídica.*
...
![Ilustração de um relógio de parede com os ponteiros distorcidos e ondulados, ao lado de um pequeno sol e uma lua, sugerindo desorientação temporal](/img/04-relogio-desorientado.png)
*Quando o relógio interno já não segue a mesma lógica.*
...
![Ilustração vista de cima de várias mãos formando um círculo ao redor de uma cadeira de rodas e uma bengala no centro](/img/05-rede-cuidado-maos.png)
*Uma rede de cuidado que nenhuma família consegue montar sozinha.*
...
![Ilustração de duas mãos se dando as mãos suavemente, uma mais enrugada e outra mais jovem](/img/06-maos-dadas.png)
*Voltar a ser filho, não cuidador.*
...
![Ilustração de uma balança antiga de três pratos perfeitamente equilibrados, representando rede de suporte, capacidade funcional e segurança do ambiente](/img/07-balanca-tres-pratos.png)
*A decisão nunca é sobre um fator só — é sobre o equilíbrio dos três.*
...
Convido você a refletir: qual é a qualidade do tempo que você passa com seu ente querido hoje? Não podemos escolher se um dia essa pergunta vai bater à nossa porta. Mas podemos escolher enfrentá-la com informação, sem culpa e sem julgamento — olhando para o que realmente protege quem amamos, e não apenas para o que a sociedade espera que digamos.
