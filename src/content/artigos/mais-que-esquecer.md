---
titulo: "Mais do que Esquecer: Como Reconhecer os Sinais do Alzheimer"
subtitulo: "Por que o diagnóstico não é sobre memória — é sobre autonomia"
categoria: "Família"
...
![Ilustração em line art de uma pequena figura humana perdida dentro de um labirinto complexo](/img/01-capa-labirinto.png)
...
![Ilustração em line art de uma pessoa olhando para o próprio reflexo em um espelho oval](/img/05-anosognosia-espelho.png)
...
![Ilustração em line art de uma panela no fogão cercada por ingredientes organizados na bancada](/img/07-teste-cozinha.png)
...
![Ilustração em line art de uma cabeça de perfil com o cérebro conectado a símbolos de linguagem, praxia, orientação e cálculo](/img/06-regra-memoria-mais-um.png)
...
![Ilustração em line art de três rostos em sequência, do neutro ao visivelmente angustiado](/img/03-tripe-comportamental.png)
...
![Ilustração em line art de uma lupa ampliando um frasco, um comprimido, uma gota e um relógio de bolso](/img/08-causas-reversiveis.png)
...
![Ilustração em line art de uma linha que sobe suavemente e depois dispara na vertical, sugerindo uma mudança brusca](/img/02-emergencia-delirium.png)
...
![Ilustração em line art de figuras subindo uma escada, cada vez mais amparadas pela seguinte](/img/04-jornada-cuidador.png)
...
![Ilustração em line art de uma lista com itens marcados e uma xícara de café ao lado](/img/09-checklist-final.png)
